...
import { motion } from "framer-motion";
import { useGetUserProfileQuery, useUpdateUserProfileMutation } from "../Redux/UserApiSlice";
...
const ProfilePage = () => {
  ...
  // Initialize user state when profileData loads
  useEffect(() => {
    if (profileData) {
      setUser({
  ...
  const handleUpdate = async () => {
    try {
      ...
      // Cache will automatically refresh due to invalidatesTags
    } catch (err) {
      console.error(err);
